    ...
    return (
        <Container>
            <Card border="info" >
                ...
                <Card.Body>
                    <Card.Text>
                    When returning from a spiritual journey through the Earth, Monty McMansions decided to dedicate some of his fortune to offering spritiual wellness for others back in his hometown.
                    </Card.Text>
                    <Card.Text>
